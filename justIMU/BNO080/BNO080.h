...
#define SHTP_RX_PACKET_SIZE 33000
...
public:
	 ...
	 */
	BNO080Base(BufferedSerial* debugPort, PinName user_INTPin, PinName user_RSTPin);
...
public:
	 ...
	 */
	BNO080I2C(BufferedSerial* debugPort, PinName user_SDApin, PinName user_SCLpin, PinName user_INTPin, PinName user_RSTPin, uint8_t i2cAddress=0x4a, int i2cPortSpeed=400000);
...
public:
	 ...
	 */
	BNO080SPI(BufferedSerial* debugPort, PinName rstPin, PinName intPin, PinName wakePin, PinName misoPin, PinName mosiPin, PinName sclkPin, PinName csPin, int spiSpeed=3000000);
